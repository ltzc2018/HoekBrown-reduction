...
class HBReductionApp(QMainWindow):
    ...
    def _create_input_panel(self) -> QWidget:
        ...
        self.combo_modulus_method.addItems(["\u65b9\u6cd54 (Hoek\u7ecf\u9a8c)", "\u65b9\u6cd51", "\u65b9\u6cd52", "\u65b9\u6cd53"])
    ...
    def run_computation(self):
        ...
        try:
            ...
            modulus_params = RockMassModulus(
                ...
                gsi=params.gsi,
                D=params.D,
                Ei_input=ei_val if method_idx == 0 else None,
                MR=mr_val if method_idx == 1 else None,
            )

            sigma_3 = self.spin_sigma3.value()
            n_points = self.spin_n_points.value()

            self.analysis_result = run_analysis(params, modulus_params, sigma_3, (0, 0.5, n_points))
